-- ====================================================================
-- Vibe Analytics :: Demand Sensing :: Snowflake Horizon DDL
...
CREATE OR REPLACE TABLE DIM_EXTERNAL_MACRO (
    ...
    month_start                      DATE NOT NULL COMMENT 'First calendar day of the macro month.',
...
CREATE OR REPLACE TABLE FACT_DEMAND_DAILY (
    transaction_date                 DATE NOT NULL COMMENT 'Calendar day of the demand record (grain).',
...
CREATE OR REPLACE TABLE FACT_FORECAST (
    ...
    week_start_date                  DATE COMMENT 'Sunday week-start date for the fiscal week.',
...
--
--   -- Master fact (partitioned — upload all 41 part files)
--   snowsql> PUT file://demand_sensing/output/FACT_DEMAND_DAILY/part-*.parquet @DEMANDSENSING_STAGE/FACT_DEMAND_DAILY/ AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
--
...
--   Click "Upload" and drag-and-drop files. For FACT_DEMAND_DAILY, create a
--   sub-folder called FACT_DEMAND_DAILY/ in the stage first.
-- =====================================================================
...
-- Master fact (partitioned — loads all 41 part files in parallel)
COPY INTO FACT_DEMAND_DAILY
    FROM @DEMANDSENSING_STAGE/FACT_DEMAND_DAILY/
...
-- =====================================================================
-- STEP 5 — Quick validation row counts (run after COPY INTO)
-- =====================================================================
